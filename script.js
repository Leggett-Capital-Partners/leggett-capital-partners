...
(function () {
  ...
  const MEMBERS = {
    ...
    seslee: {
      ...
      bio: [
        `Seslee is a Senior Accountant at Leggett Capital Partners, where she leads the accounting and financial management of Starlight Campgrounds, NewFound Partners and Title divisions, as well as being involved with the Opportunities Group. In her role, she helps ensure the accuracy and integrity of financial reporting while delivering the timely and reliable information executive leadership needs to make informed business and investment decisions. She is dedicated to strengthening the firm's accounting operations through continuous process improvement, enhanced workflows, and scalable systems that empower the accounting team and support the firm's continued growth.`,
